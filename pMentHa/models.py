...
class Question(models.Model):
    ...
    def __str__(self):
        return f"{self.text[:30]}, min:{self.min}, max:{self.max}"
...
class Answer(models.Model):
    ...
    def __str__(self):
        return f"{self.text}, {self.quotation}"
...
class Dimension(models.Model):
    ...
    def __str__(self):
        return f"{self.dimension}, {self.question}"
...
class SubDimension(models.Model):
    ...
    question = models.ForeignKey('Question', on_delete=models.SET_NULL, null=True)
    quotation = models.ForeignKey('Answer', on_delete=models.SET_NULL, null=True)

    def __str__(self):
        return f"{self.subDimension}, {self.question}, {self.quotation}"
